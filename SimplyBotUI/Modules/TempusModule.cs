...
namespace SimplyBotUI.Modules
{
    ...
    public class TempusModule : ExtraModuleBase
    {
        ...
        public async Task GetDemoRecord(string map)
        {
            ...
            await ReplyNewEmbed($"**Demo WR** - {result.MapInfo.Name} - {demoRecord.Name} - {demoRecord.FormattedDuration}");
        }
        [Command("dtime")]
        ...
        public async Task GetSoldierRecord(string map)
        {
            ...
            await ReplyNewEmbed($"**Solly WR** - {result.MapInfo.Name} - {demoRecord.Name} - {demoRecord.FormattedDuration}");
        }
        [Command("stime")]
